  ...
  return (
    <section className="py-20 md:py-28 bg-brand-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer stagger={0.15} className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((t, i) => (
            <StaggerItem key={i} animation="fadeUp">
              <div className="card p-6 md:p-8 relative hover:-translate-y-1 transition-transform duration-300">
